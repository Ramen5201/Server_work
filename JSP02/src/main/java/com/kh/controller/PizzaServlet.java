...
public class PizzaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String address = request.getParameter("address"); // 경기도 xx
		String message = request.getParameter("message"); // 리뷰할게요
		
		String pizza = request.getParameter("pizza");
		String[] toppings = request.getParameterValues("topping"); // ["고구마무스", "치즈토핑" ...] or null
		String[] sides = request.getParameterValues("side"); // ["콜라", "사이다" ...] or null
		String payment = request.getParameter("payment"); // 현금 또는 카드
